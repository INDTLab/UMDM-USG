...
# prompt = "a blue whale flying over the city --ar 2:1"
# prompt_clean = "a blue whale flying over the city"
# prompt_show = "prompt: a blue whale flying over the city\nSize: --ar 2.0, ..."
# default_hw = tensor([[1408.0, 704.0]])
# closest_ratio = tensor([2.0])
# custom_hw = tensor([[1408.0, 704.0]])
