...
class TrainingConfig(BaseConfig):
    ...
    validation_prompts: List[str] = field(
        default_factory=lambda: [
            "The murky, vibrant coral reef displays a complex underwater landscape of rock formations and diverse marine life.",
            "A translucent jellyfish gracefully drifts through the blue water, displaying delicate tentacles and a patterned bell",
            "A vibrant blue tang gracefully swims amidst colorful coral reefs in the clear, sunlit ocean depths.",
            "A scuba diver explores a vibrant coral reef in the Red Sea, observing a colorful nudibranch gracefully swimming nearby.",  
        ]
    )
